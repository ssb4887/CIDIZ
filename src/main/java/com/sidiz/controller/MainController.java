...
import com.sidiz.service.BbsService;
import com.sidiz.service.UsersService;
...
////////////////////////////////////////////////////////////////////////////////////////////////
	// 브랜드 스토리 찾아가기
		...
		// product_t55 찾아가기
		@RequestMapping(value = "/product_t55", method = RequestMethod.GET)
		public String product_t55(Model model) throws Exception {
			
			return "sub/product_t55";
		}
		...
		public String addBasketAction(Basket basket, HttpSession session, RedirectAttributes ra, HttpServletRequest request) throws Exception {
			
			String user_id = (String) session.getAttribute("user_id");
			String product= usersService.searchProductAction(basket.getProduct_name());
			
			// 헤더에서 이전 페이지 읽은 후 뒤로 가기
